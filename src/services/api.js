...
export async function queryPlate() {
  return request(`${SITE_URL.SERVER_API}/api/ridebooking/plate`, {
    method: 'GET',
  });
}

export async function queryDriver() {
  return request(`${SITE_URL.SERVER_API}/api/ridebooking/driver`, {
    method: 'GET',
  });
}
...
export async function submitDriverForm(params, token) {
  return request(`${SITE_URL.SERVER_API}/api/ridebooking/driver`, {
    method: 'POST',
    body: params,
    headers: {
...
export async function deleteDriver(params, token) {
  return request(`${SITE_URL.SERVER_API}/api/ridebooking/driver/${params.id}`, {
    method: 'DELETE',
    headers: {
      Authorization: token,
    },
...
export async function submitPlateForm(params, token) {
  return request(`${SITE_URL.SERVER_API}/api/ridebooking/plate`, {
    method: 'POST',
    body: params,
    headers: {
...
export async function deletePlate(params, token) {
  return request(`${SITE_URL.SERVER_API}/api/ridebooking/plate/${params.id}`, {
    method: 'DELETE',
    headers: {
      Authorization: token,
    },
...
export async function fakeAccountLogin(params) {
  return request(`${SITE_URL.SERVER_API}/api/users/login`, {
    method: 'POST',
    body: params,
  });
}
