export default {
  ...
  'menu.posts': 'Posts',
  'menu.posts.basicform': 'Basic Form',
  'menu.form': 'Form',
  ...
  'menu.ride-booking.driver.list': 'Driver List',
  'menu.ride-booking.driver.add': 'Add',
  'menu.rooms': 'Room',
  'menu.rooms.all': 'Room One',
  'menu.rooms.other': 'Room Two',
