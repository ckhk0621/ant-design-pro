...
@connect(({ ridebooking, loading }) => ({
  plate: ridebooking.plate,
  loading: loading.models.ridebooking,
}))
@Form.create()
class PlateTableList extends PureComponent {
  state = {
    selectedRows: [],
    visible: false,
    done: false,
          ...
          <div className={styles.tableList}>
            <div className={styles.tableListOperator}>
              <Button
                icon="plus"
                type="primary"
                onClick={() => router.push('/ride-booking/plate/create')}
              >
                Add Plate
              </Button>
            </div>
